...
<div class="v-page-header">
    ...
    <div class="actions">
        ...
        @elseif($routePrefix === 'admin' && $election->isEnded())
        <span class="btn btn-secondary" style="opacity:0.65;cursor:default;pointer-events:none;" title="Ended elections are read-only">
            Details locked
        </span>
        @endif
    </div>
