...
<aside class="v-sidebar">
    ...
    <nav class="v-nav">
        ...
        <a href="{{ route('admin.elections.index') }}" class="v-nav__item {{ request()->routeIs('admin.elections*') && ! request()->routeIs('admin.elections.trash*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.elections.trash.index') }}" class="v-nav__item {{ request()->routeIs('admin.elections.trash*') ? 'active' : '' }}">
